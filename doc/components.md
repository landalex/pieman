...
* [Das U-Boot](https://denx.de/wiki/U-Boot) and the utilities related to it which are used to make booting the built images on some single-board computers possible. 
